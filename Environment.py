...
class environment:
    def __init__(self, mes, mes1, guang=True):
        ...
        self.pro = 0
        self.guang = guang
        self.regu = mes1['zhenze']
        self.zaoshen = mes1['zaoshen']
    ...
    def state(self, action):
        ...
        if restraint_loss < self.restraint_loss:
            reward1 = np.tanh(0.3*(data_loss-1))*0.5
        ...
        return self.obs, sumreward,reward,reward1, done, data_loss
